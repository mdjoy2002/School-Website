...
DEBUG = False
# Configure allowed hosts via environment, default to localhost for safety
...
# Basic security hardening suitable for production.
# Note: adjust `SECURE_SSL_REDIRECT` and HSTS if you serve traffic over HTTPS.
