...
class Testimonial(models.Model):
    STATUS_CHOICES = (
        ...
        ('ssc_passed', 'SSC Passed'),
    )

    student = models.OneToOneField(
        Student,
        on_delete=models.CASCADE,
        related_name='testimonial_record',
        verbose_name='Student',
    )
    serial_number = models.PositiveIntegerField(unique=True, null=True, blank=True, verbose_name='Serial Number')
    generated_date = models.DateField(null=True, blank=True, verbose_name='Generated Date')
    ...
    ssc_year = models.CharField(max_length=4, blank=True)
    ssc_board = models.CharField(max_length=100, blank=True)
    candidate_type = models.CharField(max_length=30, blank=True, default='Regular')
